...
盖时间有限，我们必须有所取舍，方能有所成就。所以克制就成了一项必备技能。比如，想要学习的东西太多，就需要约束在一个范围里面。

- Linux。暂时没用，无论是工作中还是生活中都用不着。所以应先搁置；
...
不过印象中这样会让自己一下子精神起来……先试试吧。

找到一个不错的Anki专栏，可以研究研究。不过还是那句老话，不要在工具上花太多时间。
