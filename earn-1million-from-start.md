...
这在《刻意练习》里面被称为学习其心理表征。不过到底什么是有效的心理表征呢？
...
以下为软件部分。软件部分应有一个原则，即数据归用户所有，可以方便的导出。任何不提供导出选项的软件，都是耍流氓，都不予考虑。
